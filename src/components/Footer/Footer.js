...
export default function Footer() {
    return (
        <footer className="footer bottom-0 inset-x-0 z-50 border-t-1 border-gray-400 pb-2">
            <div className="bg-gray border-t-2 border-gray-400 py-4 underline">
                <p
